...
public class Clients extends Persona {
    ...
    public Clients(int idpersona, int dni, String nom, String cognoms) {
        super(idpersona, dni, nom, cognoms);
    }

    public Clients(int idpersona, int dni, String nom, String cognoms, LocalDate naixement, int tlf,
